...
<div class="card d-none d-lg-block mb-3">
    <div class="card-body d-flex flex-wrap">
        ...
        <a href="{{ route('order-delivery.index') }}" class="btn {{ request()->routeIs('order-delivery.index') ? 'btn-secondary' : 'btn-primary' }}" style="margin: 5px;">Order Delivery</a>
        <a href="{{ route('timesheet.index') }}" class="btn {{ request()->routeIs('timesheet.index') ? 'btn-secondary' : 'btn-primary' }}" style="margin: 5px;">Timesheet</a>
    </div>
</div>
...
<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
    ...
    <div class="offcanvas-body">
        <div class="d-grid gap-2">
            ...
            <a href="{{ route('timesheet.index') }}" class="btn btn-primary text-start py-2 shadow-sm mt-2">
                Timesheet
            </a>
        </div>
    </div>

...
<div class="container">
    ...
    <form method="POST" action="/{{ $saleItem->id }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="customerid" class="form-control" value="{{ $saleItem->customerid }}" >
        </div>
        
        <div class="form-group">
            <label for="productid">Product ID:</label>
            <input type="text" name="productid" class="form-control" value="{{ $saleItem->productid }}" >
        </div>

...
<head>
    ...
    <style>
        ...
        /* Show only the single latest item */
...
<body>
    ...
    <div class="header">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <span id="syncText" class="text-secondary fw-bold" style="font-size: 0.70rem; text-transform: uppercase; letter-spacing: 0.05em;">Initalizing...</span>
        </div>
    </div>

...
Route::get('/saleitems/datatable', [SaleItemController::class, 'dataTable'])->name('saleitems.datatable');
Route::get('/saleitems/filter-options', [SaleItemController::class, 'filterOptions'])->name('saleitems.filter-options');
...
Route::post('/validate-product-id', [ProductController::class, 'checkProduct'])->name('validate_product_id');
...
Route::prefix('order-delivery')->group(function () {
    ...
    Route::get('/global-latest-scan', [OrderDeliveryController::class, 'globalLatestScan'])->name('order-delivery.global-latest-scan');
    ...
    Route::post('/reopen', [OrderDeliveryController::class, 'reopenOrder'])->name('order-delivery.reopen');
    Route::post('/update-ean', [OrderDeliveryController::class, 'updateEan'])->name('order-delivery.update-ean');
    Route::post('/update-session-info', [OrderDeliveryController::class, 'updateSessionInfo'])->name('order-delivery.update-session-info');
    ...
    Route::get('/{orderId}/latest-scan', [OrderDeliveryController::class, 'latestScanState'])->name('order-delivery.latest-scan');
